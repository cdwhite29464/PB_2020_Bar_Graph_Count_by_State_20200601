...
fig.update_layout(title_text = '2020 Police Brutality: {} Incidents Captured on Video<br>Data from {}<br>Created: {}'.format(len(pd_date_query),date_text,dt_string),
                  barmode='group',
                  xaxis_tickangle=-45,
                  autosize=True,
#                   width=1500,
...
fig.write_html(r"C:\Users\cdwhi\Documents\Python\My_Code\Police_Brutality_2020\PB_2020_Bar_Graph_Count_by_State_20200601\index.html")
fig.show()
